    ...
    <div class="mx-auto">
      <div class="my-4">
        ...
        <div class="p-4">
          ...
          <p class="p-2 text-lg">Event Location : Reading </p>
          <p class="pb-6">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Accusamus accusantium alias aliquam consequuntur, debitis enim error
            eveniet id, magnam maxime neque nesciunt odit quam repellendus
            sed soluta temporibus veritatis vitae!
          </p>
        </div>
      </div>
    </div>
