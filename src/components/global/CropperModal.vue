     ...
     <div class="fixed inset-0 z-10 overflow-auto mt-6">
       <div class="flex min-h-full items-end justify-center p-4 items-center py-2">
         <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all my-8 mt-10 max-w-4xl">
           <div class="bg-white px-4 pt-4 pb-4 p-6">
                 ...
                 <div class="pb-3 flex flex-row-reverse px-4">
                    <button
                        ...
                        class="
                          ...
                          focus:outline-none
                          focus:ring-2
                          focus:ring-blue-500 focus:ring-offset-2 ml-3 w-auto text-sm">Crop Image
                    </button>
                   <button
                       ...
                       class="
                        ...
                        focus:outline-none
                        focus:ring-2
                        focus:ring-red-500 focus:ring-offset-2 ml-3 w-auto text-sm">Cancel
                   </button>
                 </div>
               </div>
             </div>
